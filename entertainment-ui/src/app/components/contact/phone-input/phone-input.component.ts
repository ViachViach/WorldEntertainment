...
import { ViewChild, OnDestroy, Input, Optional, Inject, Self, ElementRef } from '@angular/core';
import { ControlValueAccessor, AbstractControl, Validators, FormBuilder, FormGroup, NgControl } from '@angular/forms';
...
@Component({
  ...
  providers: [{ provide: MatFormFieldControl, useExisting: PhoneNumberCustomInput }],
  host: {
    '[class.example-floating]': 'shouldLabelFloat',
    '[id]': 'id',
  }
})
export class PhoneNumberCustomInput
  ...
  id = `example-tel-input-${PhoneNumberCustomInput.nextId++}`;
  onChange = (_: any) => {};
  onTouched = () => {};
